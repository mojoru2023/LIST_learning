...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into ctolib_andriod_links (title,DE,link) values (%s,%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
    except TypeError:
...
if __name__ == '__main__':
    url = 'https://www.ctolib.com/android/categoriesallsub.html'
...
#
# create table ctolib_andriod_links(
