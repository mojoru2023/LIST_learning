...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into segmentfalut_flask_question (title,link) values (%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
# create table segmentfalut_flask_question(
